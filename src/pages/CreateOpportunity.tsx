...
export default function CreateOpportunity() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (profile.role === "recruiter" && !profile.is_verified) {
      toast({
        ...
        description:
          "Your recruiter account must be verified before you can post opportunities. Please wait for admin approval.",
        variant: "destructive",
      })
      return
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5 p-6 space-y-6">
      ...
      <Card
        className="bg-gradient-card border-border/50 hover:shadow-xl transition-all duration-300 animate-scale-in"
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              <Button
                type="submit"
                disabled={loading || (profile?.role === "recruiter" && !profile?.is_verified)}
